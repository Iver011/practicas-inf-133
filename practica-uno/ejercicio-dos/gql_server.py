...
import json
from graphene import ObjectType,String,List, Int,Schema,Field,Mutation,Boolean
...
class CrearPlanta(Mutation):
    ...
    def mutate(root,info,nombre,especie,edad,altura):
        nueva_planta=Planta(
            id=len(plantas)+1,
            nombre=nombre,
            especie=especie,
...
plantas =[ 
    Planta(id=1, nombre='Amapola', especie='Papaver' , edad=14 , altura=164,frutos=True),
    Planta(id=2, nombre='Helecho', especie='Filicopsida' , edad=15, altura=125,frutos=False),
